...
const GENERALS_DATA = {
  ...
  grimoire: {
    ...
    borderColor: '#ff8c00',
    description: '紅炎帝国最高の軍師。羽扇一本で戦局を読み解き、敵将の心理を見抜く知略の権化。',
  ...
  iris: {
    ...
    borderColor: '#ff1493',
    description: '聖ルシウス王国の聖教会が生んだ奇跡の聖女。神の声を聞き、治癒の奇跡を起こし続ける。',
  ...
  lancelot: {
    ...
    borderColor: '#1e90ff',
    description: '聖ルシウス王国が誇る白十字騎士団長。完璧な武芸と強靭な精神力を持つ。',
  ...
  longjan: {
    ...
    borderColor: '#00bfff',
    description: '碧海同盟の若き海賊王。自由と仲間を何より大切にする熱血漢。',
